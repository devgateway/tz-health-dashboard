...
public class OPDDiagnosticRepositoryImpl implements OPDDiagnosticRepositoryCustom {
    ...
    @Override
    public List<Long> getTopByWar(Ward w, Integer year, Integer quarter, Integer month) {
        ...
        queryFilter.add(cb.equal(from.get(OPDDiagnostic_.ward), w));
        queryFilter.add(cb.equal(from.get(OPDDiagnostic_.year), year));
    ...
    */
    ...
    @Override
    public List<OPDResponse> getDiagnosesByWard(Ward w, Integer year, Integer quarter, Integer month, List<Long> ids) {
    ...
    @Override
    public List<OPDResponse> getYearlyTotalValuesByWard(Ward w, Integer year, List<Long> ids) {
    ...
    @Override
    public List<OPDResponse> getQuarterlyTotalValuesByWard(Ward w, Integer year, Integer quarter, List<Long> ids) {
        if (ids.size() > 0) {
            CriteriaBuilder cb = em.getCriteriaBuilder();
            CriteriaQuery<OPDResponse> query = cb.createQuery(OPDResponse.class);
            Root<OPDDiagnostic> from = query.from(OPDDiagnostic.class);
    ...
    @Override
    public List<OPDResponse> getMonthlyTotalValuesByWard(Ward w, Integer year, Integer month, List<Long> ids) {
        if (ids.size() > 0) {
            CriteriaBuilder cb = em.getCriteriaBuilder();
            CriteriaQuery<OPDResponse> query = cb.createQuery(OPDResponse.class);
            Root<OPDDiagnostic> from = query.from(OPDDiagnostic.class);
