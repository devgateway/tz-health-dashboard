  ...
  resources: {
    en: {
      translations: {
        ...
        "ward search": "ward search",
        "facility search": "facility search",
        "Facility Report Description": "Search and filter facility-level data to generate a monthly, quarterly, or annual health data report.",
        "Ward Report Description": "Search and filter ward-level data to generate a monthly, quarterly, or annual health data report.",
        ...
        "Selecting period message ward": "Select the time period (yearly, quarterly, or monthly) and desired date range for the data",
        "Selecting period message facility": "Select the time period (yearly, quarterly, or monthly) and desired date range for the data",
        ...
        "The": "The ",
        "Generate Report": "Generate Report",
        "Help facility Report Generator.": "will not engage until you have selected a valid facility, time period, and date. First, select a facility, either through the search or filter boxes in Step One, then select a time period in Step Two.",
    ...
    sw: {
      translations: {
        ...
        "Hospital": "Hospitali",
        "Clinics": "Kliniki",
        "Facility Report Description": "Saka na Pakua data ya kituo ili kutoa ripoti ya data ya kila mwezi, ya kila mwaka, au kila mwaka.",
        "Ward Report Description": "Saka na Pakua data ya kata ili kutoa ripoti ya data ya kila mwezi, ya kila mwaka, au kila mwaka.",
        ...
        "ward search": "Chuja Kata",
        "facility search": "Chuja Kituo",
        "below": "hapa chini",
        "OR": "AU",
        ...
        "Selecting period message ward": "Baada ya kuchagua kata kipindi (kila mwaka, robo mwaka, au kila mwezi) na tarehe ya unayotaka",
        "Selecting period message facility": "Baada ya kuchagua kituo kipindi (kila mwaka, robo mwaka, au kila mwezi) na tarehe ya unayotaka",
        "Time Period": "Muda",
        "Date": "Tarehe",
        "Click on the": "Bonyeza kwenye",
        "Generate Report": "Toa Taarifa",
        "button to create your custom data report, or click on the": "kibonyezo la unda taarifa data maalum, au bonyeza kwenye",
        "Reset": "Rejesha",
        "button to clear all search and filter selections": "kibonyezo la kuondoa chaguo zilizopo",
        "The": "",
        "Generate Report": "Toa Taarifa",
        "Help facility Report Generator.": "Haitaweza kutendeka mpaka ufanyike uchaguzi wa kituo sahihi, kipindi na tarehe. Kwanza chagua kituo, kupitia kisanduku cha uchaguzi kwenye hatua ya kwanza, kisha chagua kipindi kwenye hatua ya pili.",
        "Help ward Report Generator.": "Haitaweza kutendeka mpaka ufanyike uchaguzi wa kata sahihi, kipindi na tarehe. Kwanza chagua kata, kupitia kisanduku cha uchaguzi kwenye hatua ya kwanza, kisha chagua kipindi kwenye hatua ya pili.",
        "Copy link to share": "Copy link to share",
        "Print as PDF": "Print as PDF",
        "Jan": "Jan",
        "Feb": "Feb",
