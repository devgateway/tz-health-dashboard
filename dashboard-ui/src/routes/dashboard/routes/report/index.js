...
const createRoute = (props) => {
  ...
  return (<div>
    <Route path="/:locale/report/facility/:id/:period?" exact={true}  render={({match}) => <FacilityReport store={store} params={match.params}/>}/>
    <Route path="/:locale/report/ward/:id/:period?" exact={true} render={({match}) => <WardReport store={store} params={match.params}/>}/>
  </div>)
}
